...
(function () {
	...
	if (typeof window.conf["FT_SingleLevel"] === "undefined") {
		window.conf["FT_SingleLevel"] = getConf;
	}
	if (typeof window.conf["FT_SingleLevel_testdata"] === "undefined") {
		testData = "[]";
		window.conf["FT_SingleLevel_testdata"] = testData;
	}
})();
