/*
Name:        	JM_UI_JobEnd.js
Description: 	JM_UI_JobEnd js file containing global logic pertaining to the JM_UI_JobEnd Form.

Ver		Release		By						Date				Change Description
001		00.50			Ramesh V			2024-05-16	#2620 First version.
002		00.70			João Caldeira 2024-11-19	#3942 Updated form and file name from JM_UI_End to JM_UI_JobEnd.
																					Added code to dispatch event on job end.
...
((window) => {
	...
	function JobEnd() {
		 ...
		 */
		function iwJobEndOnPostWorkflow(blockingOutput, workflowStatus) {
			...
			if (workflowStatus === FT.WorkTasks.WF_STATUS.finishedSuccessfully) {
				FT.Common.windowEventDispatch("jm", "jm.job.end", FT.Common.EVENT_SOURCE_TYPE.form, "JM_UI_JobEnd", "jm.job.end");
			}
		}
		/**
		...
		return {
			...
			iwJobEndOnPostWorkflow: iwJobEndOnPostWorkflow,
		};
	}
})(window);
