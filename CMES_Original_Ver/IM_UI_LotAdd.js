/*
Name:        	IM_UI_LotAdd.js
Description: 	IM_UI_LotAdd js file containing logic pertaining to the add Lot form.

Ver		Release	    By					Date					Change Description
001		01.02.00  	Praveen  		2025-06-18		#5097 First version.
*/
...
((window) => {
	...
	function LotAdd() {
		 ...
		 */
		function iwAddLotOnPostWorkflow(blockingOutput, workflowStatus) {
			...
			if (workflowStatus === FT.WorkTasks.WF_STATUS.finishedSuccessfully) {
				FT.Common.windowEventDispatch("im", "im.lotAdd.add", FT.Common.EVENT_SOURCE_TYPE.form, "IM_UI_LotAdd", "im.lotAdd.add");
			}
		}
		...
		return {
			...
			iwAddLotOnPostWorkflow: iwAddLotOnPostWorkflow,
