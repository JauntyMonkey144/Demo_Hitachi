/*
Name:        	IM_UI_SublotAttributeView.js
Description: 	IM_UI_SublotAttributeView js file containing logic pertaining to the view Sublot Atttibutes form.

Ver		Release	     By			    Date			    Change Description
001		01.02.00  	 Praveen  	2025-06-07		#5114 First version.
*/

((window) => {
	//  ------------------------------ Global Variables ------------------------------------
	window.IM = window.IM || {};
	IM.SublotAttributeView = IM.SublotAttributeView || {};
	IM.SublotAttributeView = SublotAttributeView();
	//  ------------------------------------------------------------------------------------
	/**
	 * formFunctions
	 *
	...
	function SublotAttributeView() {
		...
		function initializeForm(Control) {
			...
			_controls.txSublot_no = FORM.Control.findByXmlNode("TXSLN");
		...
		function bindLotAttrDetails() {
			...
			_controls.txSublot_no.value = lotAttr.sublot_no;
