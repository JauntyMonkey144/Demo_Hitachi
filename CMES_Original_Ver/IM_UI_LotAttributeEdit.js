/*
Name:        	IM_UI_LotAttributeEdit.js
Description: 	IM_UI_LotAttributeEdit js file containing logic pertaining to the Edit Lot Atttibutes form.

Ver		Release	    By			    Date			    Change Description
001		01.02.00  	Praveen  		2025-06-07		#5110 First version.
*/

((window) => {
	//  ------------------------------ Global Variables ------------------------------------
	window.IM = window.IM || {};
	IM.LotAttributeEdit = IM.LotAttributeEdit || {};
	IM.LotAttributeEdit = LotAttributeEdit();
	//  ------------------------------------------------------------------------------------
	/**
	 * formFunctions
	 *
