/*
Name:        	JM_UI_JobCancel.js
Description: 	JM_UI_JobCancel js file containing global logic pertaining to the JM_UI_JobCancel Form.

Ver		Release	  By				Date		Change Description
001		00.50	  Ramesh V			2024-05-16	#2766	First version.
002		00.70	  João Caldeira     2024-11-19	#3942 Updated form and file name from JM_UI_Cancel to JM_UI_JobCancel.
																					Added code to dispatch event on job cancel.
...
((window) => {
	// ------------------------------ Global Variables ------------------------------------
	window.JM = window.JM || {};
	JM.JobCancel = JM.JobCancel || {};
	JM.JobCancel = JobCancel();
	// ------------------------------------------------------------------------------------
	/**
	 * formFunctions
	 *
	...
	function JobCancel() {
		 ...
		 */
		function iwJobCancelOnPostWorkflow(blockingOutput, workflowStatus) {
		...
		return {
			...
			iwJobCancelOnPostWorkflow: iwJobCancelOnPostWorkflow,
		};
	}
})(window);
